$(document).ready(function(){
	...
	var iEditHTML = '<div class="iEdit-img-edit"><canvas class="iEdit-img-edit-can"></canvas><canvas class="iEdit-img-edit-process-can"></canvas><div class="iEdit-img-edit-select" width="20" height="20"><div class="iEdit-img-edit-select-resize"></div></div><div class="iEdit-img-edit-act iEdit-img-edit-save"> Kes </div><div class="iEdit-img-edit-act iEdit-img-edit-cancel"> Vazgeç </div></div>';
	...
	window.iEdit = {
		...
		open: function(imgObj, square, callback, imageType, imageQuality){
			$("#musteripanel").modal('hide');
			$('label.file input:valid + .file').css('display','none');
	...
	iEdit.cancelBtn.on("click", function(){
		...
		$('label.file input:valid + .file').css('display','block');
		$("#musteripanel").modal('show');
		$("#file").val()=null;
